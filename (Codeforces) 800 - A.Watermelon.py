...
output: YES
Note: For example,
the boys can divide the watermelon into two parts of 2 and 6 kilos respectively 
(another variant — two parts of 4 and 4 kilos).
"""


weightNumber = int(input())
while weightNumber <1 and weightNumber >100:
    weightNumber =int(input()) 
if weightNumber%2 == 0 and weightNumber != 2:
    print("YES")
else:
    print("NO") 